...
{
    public abstract class BatDemoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BatDemoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BatDemoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BatDemoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BatDemoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BatDemoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BatDemoDbContext, Task<T>> func)
        {
            T result;
